...
%nsisbinpath%\GenPat.exe  "C:\projects\portalhebrew\gamefiles\portal2\pak01_dir_orig.vpk" "C:\projects\portalhebrew\gamefiles\portal2\pak01_dir.vpk"  C:\projects\portalhebrew\gamefiles\portal2\update\pak01_dir.vpk.patch
