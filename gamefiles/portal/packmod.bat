...
copy gamefiles\portal\rtlexe\portl_readme.txt gamefiles\portal\dist
cd gamefiles\portal\dist
start "" "C:\Program Files\7-Zip\7z.exe" a install_portal_heb_win_rtl_ex.zip install_portal_heb_win_rtl.exe apply_fonts_portal_hebrew.reg remove_fonts_portal.reg portl_readme.txt
start "" "C:\Program Files\7-Zip\7z.exe" a install_portal_heb_win_rtl.zip apply_fonts_portal_hebrew.reg remove_fonts_portal.reg
:: wait 10 seconds.
ping 192.0.2.2 -n 1 -w 10000 > nul
DEL *.reg
DEL  install_portal_heb_win_rtl.exe
