...
start "" "c:\Program Files\7-Zip\7z.exe" x gamefiles\portal\dist\install_portal_heb_win_rtl_ex.zip -o"gamefiles\portal\dist" -y
:: wait 5 seconds. Seriously.
ping 192.0.2.2 -n 1 -w 5000 > nul
gamefiles\portal\testmod_generic.bat rtl
del gamefiles\portal\dist\install_portal_heb_win_rtl.exe
